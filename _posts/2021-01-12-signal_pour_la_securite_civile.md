...
En gestion de crise, la **simplicité**, la **disponibilité** et la **résilience aux conditions de travail dégradées** sont souvent plus appréciées par les utilisateur.rice.s que les autres facteurs, *a fortiori* dans un environnement multi-organisations, et sont dès lors souvent plus fortement pondérées que les autres dans ce tableau. La sécurité (confidentialité, vie privée, intégrité, ...) mériterait cependant une attention plus grande. Au vu des outils courramment utilisés, la souveraineté (même européenne) numérique en sécurité civile ne semble pas une priorité en Belgique.
